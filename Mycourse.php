        ...
        <div class="container">
            <div class="courses-list">
                <div class="row">
                    ...
                    $course_query = "Select course.C_image,course.C_Name,course.C_Des,course.C_ID,course.C_OPrice FROM course INNER JOIN payment ON course.C_ID = payment.C_ID WHERE payment.S_ID=$_SESSION[Id]";
                        ...
                        <div class="col-xl-3 col-lg-4 d-lg-none d-xl-block col-md-6">
                            <div class="footer-widget mb-30">
                                ...
                                <div class="recent-post d-flex">
                                    ...
                                    <div class="recent-post-text">
                                        <p>Harvard instructor comes with new course.</p>
                                        <div class="footer-time">
                                            <span class="ti-time"></span>
                                            <span class="footer-published-time">01 March 2022</span>
                                        </div>
