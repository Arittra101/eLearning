    ...
    <nav style="padding-top: 80px;" class="col-md-2 d-none d-md-block  sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link  active" href="admin_course.php">
      ...
      <div style="text-align: center;"  class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php
            ...
            $rs = mysqli_query($conn,"SELECT `F_ID`, `S_Name`, `S_ID`, `S_Email`, `F_Des` FROM `feedback` "); //object <
            while($row = mysqli_fetch_array($rs))
            {
              ...
              echo "<td>"; echo $row["F_Des"]; echo "</td>"; 
              echo "<td>"; ?>  <a class ="btnId" href="feedback_delete.php?id=<?php echo $row["F_ID"]?>">Deletes</a> <?php echo "</td>";
              echo "</tr>";
            } 
