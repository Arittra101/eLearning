    ...
    <nav style="padding-top: 80px;" class="col-md-2 d-none d-md-block  sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link  active" href="admin_feedbacks.php">
      ...
      <div style="text-align: center;"  class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php
            ...
            $rs = mysqli_query($conn,"SELECT `S_ID`, `S_FName`, `S_LName`, `S_Email`, `S_Mobile` FROM `student` "); //object <
            while($row = mysqli_fetch_array($rs))
            {
              echo "<tr>";
              echo "<td>"; echo $row["S_ID"]; echo "</td>";
              echo "<td>"; echo $row["S_FName"]; echo "</td>";
              echo "<td>"; echo $row["S_LName"]; echo "</td>"; 
              echo "<td>"; echo $row["S_Email"]; echo "</td>"; 
               
              echo "<td>"; ?>  <a class ="btnId" href="student_delete.php?id=<?php echo $row["S_ID"]?>">Deletes</a> <?php echo "</td>";
              echo "</tr>";
            } 
